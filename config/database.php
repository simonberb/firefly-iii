...
return [
    ...
    'connections' => [
        ...
        'mysql'  => [
            'driver'      => 'mysql',
            'host'        => envNonEmpty('AZURE_MYSQL_HOST', $host),
            'port'        => envNonEmpty('AZURE_MYSQL_PORT', $port),
            'database'    => envNonEmpty('AZURE_MYSQL_DBNAME', $database),
            'username'    => envNonEmpty('AZURE_MYSQL_USERNAME', $username),
            'password'    => env('AZURE_MYSQL_PASSWORD', $password),
    ...
    */
    'redis'       => [
        ...
        'cache'   => [
            ...
            'url'      => envNonEmpty('REDIS_URL'),
            'path'     => envNonEmpty('REDIS_PATH'),
            'host'     => envNonEmpty('AZURE_REDIS_HOST', '127.0.0.1'),
            'port'     => envNonEmpty('AZURE_REDIS_PORT', 6379),
            'username' => env('REDIS_USERNAME'),
